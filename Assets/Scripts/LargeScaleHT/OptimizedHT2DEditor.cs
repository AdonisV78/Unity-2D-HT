...
[CustomEditor(typeof(OptimizedHT2D))]
public class OptimizedHT2DEditor : Editor
{
    ...
    SerializedProperty displayPlane;
    ...
    private void OnEnable()
    {
        ...
        displayPlane = serializedObject.FindProperty("displayPlane");
    ...
    {
        OptimizedHT2D _HT2D = (OptimizedHT2D)target;
        ...
        EditorGUILayout.PropertyField(displayPlane);
